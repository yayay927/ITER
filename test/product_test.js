...
describe('products', async () => {
    it("select all products without setting page", async () => {
        ...
        const product2Expect = {
            ...
            main_image: 'http://127.0.0.1:3000/assets/2/main.jpg',
            images: [
                'http://127.0.0.1:3000/assets/2/0.jpg',
                'http://127.0.0.1:3000/assets/2/1.jpg',
                'http://127.0.0.1:3000/assets/2/0.jpg',
                'http://127.0.0.1:3000/assets/2/1.jpg'
            ]
        }
    ...
    it("select product detail", async () => {
        ...
        const expect = {
            ...
            main_image: 'http://127.0.0.1:3000/assets/1/main.jpg',
            images: [
                'http://127.0.0.1:3000/assets/1/0.jpg',
                'http://127.0.0.1:3000/assets/1/1.jpg',
                'http://127.0.0.1:3000/assets/1/0.jpg',
                'http://127.0.0.1:3000/assets/1/1.jpg'
            ]
        }
